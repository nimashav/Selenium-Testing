...
public class Radio_CheckBox_Example {
    ...
    public void radioTests(){
        ...
        boolean firefoxeradioOption = driver.findElement(By.id("j_idt87:console2:1")).isSelected();
...
//                System.out.println("Default Selected Radio Button Text:" + defaultSelectedRadioText);
//                break;
//            }
//        }
...
//                WebElement myAgeRadioOption = driver.findElement(By.xpath("//label[text(0='" +ageGroupText + "']/parent::div//input"));
